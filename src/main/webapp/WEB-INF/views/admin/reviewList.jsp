...
<div class="admin-layout">
    ...
    <aside class="sidebar">
        ...
        <ul class="menu-list">
            ...
            <li><a href="${contextPath}/admin/reviews" class="active">리뷰 관리</a></li>
        </ul>
    </aside>
    ...
    <main class="main">
        ...
        <div class="top-bar">
            <div class="page-title">
                <h1>리뷰 관리</h1>
                <p>회원들이 작성한 리뷰를 확인하고, 부적절한 리뷰는 BLOCKED 상태로 전환합니다.</p>
            </div>
        ...
        <section class="panel">
            ...
            <div class="search-box">
                <form class="search-form" action="${contextPath}/admin/reviews" method="get">
                    <input type="text"
                           name="restaurantName"
                           class="search-input"
                           value="${restaurantName}"
                           placeholder="음식점 이름으로 리뷰 검색">
                    ...
                    <a href="${contextPath}/admin/reviews" class="btn btn-soft">전체 보기</a>
                </form>
            </div>
                ...
                <c:otherwise>
                                ...
                                <c:forEach var="review" items="${reviewList}">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <span style="font-size:12px; color:#9b7b64;">
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${not empty review.image}">
                                                    <span style="font-size:13px; color:#b45309;">첨부 있음</span>
                                                </c:when>
                                                <c:otherwise>
                                        ...
                                        <td>
                                            <form class="action-form"
                                                  action="${contextPath}/admin/review/status"
                                                  method="post">
                    ...
                    <div class="pagination">
                        ...
                        <c:if test="${pageDTO.prev}">
                            <a class="page-link"
                               href="${contextPath}/admin/reviews?page=${pageDTO.startPage - 1}&size=${pageDTO.size}&restaurantName=${restaurantName}">
                                이전
                            </a>
                        </c:if>
                        ...
                        <c:forEach var="num" begin="${pageDTO.startPage}" end="${pageDTO.endPage}">
                            <a class="page-link ${pageDTO.page == num ? 'active' : ''}"
                               href="${contextPath}/admin/reviews?page=${num}&size=${pageDTO.size}&restaurantName=${restaurantName}">
                                ${num}
                            </a>
                        </c:forEach>
                        ...
                        <c:if test="${pageDTO.next}">
                            <a class="page-link"
                               href="${contextPath}/admin/reviews?page=${pageDTO.endPage + 1}&size=${pageDTO.size}&restaurantName=${restaurantName}">
                                다음
                            </a>
                        </c:if>
                    ...
                    <div class="page-info">
                        총 ${pageDTO.totalCount}개 리뷰 /
                        현재 ${pageDTO.page}페이지 /
                        총 ${pageDTO.totalPage}페이지
                    </div>
                </c:otherwise>
            </c:choose>
