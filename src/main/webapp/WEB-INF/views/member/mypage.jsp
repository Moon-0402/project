...
.content-grid {
    display: grid;
    grid-template-columns: minmax(420px, 650px) 320px;
    gap: 24px;
    align-items: start;
}
...
<div class="page-wrap">
    ...
    <aside class="sidebar">
        ...
        <ul class="menu-list">
            ...
            <li><a href="${pageContext.request.contextPath}/member/mypage" class="active">내 정보 수정</a></li>
                ...
                <section class="form-card">
                    ...
                    <form action="${pageContext.request.contextPath}/member/mypage"
                        ...
                        <div class="notice-box">
                            회원 정보 수정 후에도 로그인 상태는 유지됩니다.<br>
                            화면 상단의 이름 표시가 바로 바뀌지 않으면 로그아웃 후 다시 로그인하면 반영됩니다.
                        </div>
            ...
            <aside>
                <section class="profile-card">
                    ...
                    <div class="profile-desc">
                        PickEat에서 날씨와 상황에 맞는 맛집 추천을 받아보세요.
                    </div>
                ...
                <section class="quick-card">
                    ...
                    <a href="${pageContext.request.contextPath}/member/mypage/changePw" class="quick-link">
                        비밀번호 변경
                    </a>
